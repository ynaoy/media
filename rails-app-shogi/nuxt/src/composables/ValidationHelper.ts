...
export const SignupValidationHelper = ()=>{
    // 使うクラスの作成
...
export const LoginValidationHelper = () =>{
  // 使うクラスの作成
  const email_validation_class = new EmailValidationClass()
  const password_validation_class = new PasswordValidationClass()
...
export const KifuValidationHelper = () =>{
  // 使うクラスの作成
  ...
  return {  get_kifu_player1_validation: kifu_player1_validation_class.get,
