...
<script lang="ts" setup>
  ...
  const valid_password: (password:string, password_confirmation:any)=>boolean      
    = inject('valid_password')
  const update_password_reset :(body:{}, header:{})=>void
    = inject('update_password_reset')
