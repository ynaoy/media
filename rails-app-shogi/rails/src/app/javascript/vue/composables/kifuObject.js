...
export default function kifuObject(props){
    ...
    const kifu_states =reactive({
        state: 0,
        max_state: props.kifuText.length-1,
        board_text: [],     //[n][8][8]
    ...
    const update_board= function(event){
        ...
        kifu_states.board_text = props.kifuText[kifu_states.state];
        kifu_states.board_flg = props.kifuFlg[kifu_states.state];
        set_sub_board()
    }
