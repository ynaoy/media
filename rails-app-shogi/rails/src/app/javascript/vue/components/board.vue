<template>
  <svg id ="board" version="1.1" xmlns="http://www.w3.org/2000/svg" v-bind:width="326+board_margin_lr*2" height="346">
    <rect v-bind:width="326+board_margin_lr*2" height="346" x="0" y="0" fill="#DCF0BE"></rect>
    <rect v-bind:width="326" height="326" v-bind:x="board_margin_lr-10" v-bind:y="board_margin_ud-10" fill="#E3A936"></rect>
    ...
    <g v-if= "sub_board_width<board_margin_lr" class=sente_komadai fill="transparent">
      <rect v-bind:width= "sub_board_width" v-bind:height= "sub_board_height" v-bind:x= "board_margin_lr-0+306+15" v-bind:y= "board_margin_ud-0-sub_board_height+306"
        stroke="#000000" fill="#E3A936" stroke-width="1"></rect>
        <g v-for= "n in 8">
